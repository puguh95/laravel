                            ...
                            <td>1234567890</td>
                                ...
                                @if ($order->status_id == 1)
                                    <tr>
                                        ...
                                        <th><a href="https://wa.me/{{ env('WA_PHONE_NUMBER', '') }}?text=Halo%20admin,%20saya%20ingin%20memverifikasi%20pembayaran%20dengan%20ID:%20{{ $order->order_id }}" target="_blank" class="btn-whatsapp">WhatsApp</a></th>
                                    </tr>
                                @elseif ($order->status_id == 2)
                                    <tr>
